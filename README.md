<p align="center">
  ...
  <img src="https://img.shields.io/badge/36_Exercises-✓-brightgreen?style=for-the-badge" alt="36 Exercises">
</p>
...
<p align="center">
  ...
  深色健身主题 · 背胸肩腹四分化 · 5 日循环 · 36 个动作 · 自定义计划 · GIF 动画 + B站教学
</p>
...
**练四休一 · 5 日循环**：背 → 胸 → 肩 → 腹 → 有氧

| 🔵 背日 | 🟠 胸日 | 🟡 肩日 | 🟢 腹日 | 🔵 有氧日 |
|:---|:---|:---|:---|:---|
| 高位下拉 | 杠铃平板卧推 | 杠铃站姿推举 | 卷腹 | 缓坡快走 30-45min |
| 坐姿划船 | 哑铃上斜卧推 | 哑铃侧平举 | 平板支撑 | 燃脂心率 120-140bpm |
| 哑铃单臂划船 | 蝴蝶机夹胸 | 哑铃反向飞鸟 | 俄罗斯转体 | 脂肪氧化区训练 |
| 杠铃俯身划船 | 器械坐姿推胸 | 哑铃前平举 | 自行车卷腹 | |
| 反向划船（自重） | 俯卧撑 | 蝴蝶机反向飞鸟 | 反向卷腹 | |
| 杠铃硬拉 | 哑铃飞鸟 | | 登山者 | |

每个部位另含备选动作（动作库共 36 个动作），强度可进阶。训练计划可**自定义**——点击按钮自由增减、调整顺序。
...
| 功能 | 说明 |
|------|------|
| 📅 **自动轮换** | 基于起始日推算，背→胸→肩→腹→有氧循环，打开就知道今天练什么 |
| 📝 **自定义计划** | 每天可自由增减动作、调整顺序，保存到本地，个人化训练 |
| ⏭ **跳过今天** | 加班、有事练不了？一键顺延，后续计划自动后移 |
| 📊 **详细参数** | 热身组、正式组、组间休息、动作节奏，外加建议重量范围 |
| 🎬 **双重演示** | MuscleWiki GIF 动画（正/侧两面 + 男女模特） + B站中文教学 |
| ⚠️ **避坑指南** | 每个动作列出 3 个最常见错误，新手少走弯路 |
| 📚 **动作库** | 36 个动作按背/胸/肩/腹分类，含备选进阶动作 |
| 🟢 **腹部核心** | 卷腹、平板支撑、俄罗斯转体等 13 个腹部动作，新手→中级 |
| 🚶 **有氧燃脂** | 缓坡快走代替休息日，心率指导 + 燃脂原理说明 |
| 📱 **响应式** | 手机/平板/桌面全适配，健身房打开就能看 |
| 💾 **本地存储** | LocalStorage 记住起始日 + 自定义计划，刷新不丢失 |
...
全部 **36 个动作**数据来自 [**MuscleWiki**](https://musclewiki.com)——一个免费的交互式肌肉训练网站，提供 GIF 动画演示和肌肉发力热力图。
